// Shared setup for the DiscoveryComposer suites. Test-only: nothing in the
...
export const uploadedImage: DiscoveryAttachmentView = {
  id: "attachment-image",
  messageId: null,
...
export type ComposerProps = ComponentProps<typeof DiscoveryComposer>;
