...
describe("seedDesignScreensFromFlow", () => {
  ...
  it("maps inserted rows to CanvasScreen", async () => {
    ...
    expect(out).toEqual([
      { id: SCREEN, name: "Pick plan", canvasX: 0, canvasY: 1200, flowNodeId: "pick_plan", state: "empty", screenKey: null, formFactor: "desktop", layout: null, layoutKey: null, layoutName: null, preview: null },
    ]);
  });
