...
vi.mock("@/features/workspaces/organization-people", () => ({
...
describe("AIConnectionOnboardingPage", () => {
  ...
  it("passes the org and its active devices to the connection UI", async () => {
    ...
    expect(props.organizationId).toBe(ORGANIZATION_ID);
